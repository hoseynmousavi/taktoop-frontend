...
class MaterialInput extends Component
{
    ...
    handleChange(e)
    {
        ...
        if ((!maxLength) || (maxLength && value.length <= maxLength)) this.setState({...this.state, value}, () => this.props.getValue(event))
    }
    ...
    {
        const event = {...e}
        this.setState({...this.state, focused: false}, () => this.props.onBlur && this.props.onBlur(event))
    }
